...
public:
	...
	void SetTexture(std::string _uniform, GLuint _texture, int _textureNo){glActiveTexture(GL_TEXTURE0+ _textureNo); glUniform1i(GetUniformLocation(_uniform), _textureNo); glBindTexture(GL_TEXTURE_2D, _texture);}
